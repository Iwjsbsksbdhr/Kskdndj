...
BOT_TOKEN = "6872939909:AAEZjO5H_myQXgvUEn-jk_qMcfowCOasE0Q"
bot = TeleBot(BOT_TOKEN)

@bot.message_handler(commands=['start','help'])
def send_welcome(message):
    owner = types.InlineKeyboardButton(text="Owner",url="https://t.me/LSR_RAJPUT")
    markup = types.InlineKeyboardMarkup().add(owner)
    bot.reply_to(message,"WELCOME TO DC VIP BOT 🤡\n\n--------------------------------------------------\nDDoS:\n\t/attack <URL> <TIME>\n\n--------------------------------------------------\nLove Calculator:\n\t/love <NAME1> <NAME2>\n\n--------------------------------------------------\nCC Generator:\n\t/visa for Visa Card\n\t/mc for Mastercard\n\t/disc for Discover\n\t/amex for AmericanExpress\n\n--------------------------------------------------\nSQLI Checker:\n\t/sql <URL>\n\n-------------------------------------------------",reply_markup=markup)
